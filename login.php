    ...
    if ($user) {
        if (password_verify($_POST["password"], $user["password"])) {
            ...
            if ($user["email"] === "admin1111@gmail.com") {
                header("Location:/Serandi 2/php/dashboard.php"); // Redirect to the admin dashboard
            } else {
                header("Location: /Serandi 2/home.php"); // Redirect to the home page
            }
            exit;
        } else {
            $is_invalid = true;
...
<div class="password-container">
    ...
    <div class="form-check text-left mb-3">
            ...
            <div class="sign-up-link">
                <p>Don't have an account? <a href="signup.php" class="sign-up-text">Sign Up</a></p>
            </div>
