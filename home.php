      ...
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item">
          ...
          <div class="d-flex align-items-center ms-auto  " style="gap: 10px;">
            ...
            <!-- Shopping Bag Icon -->
            <a href="/Serandi 2/mycart.php" class="text-decoration-none text-dark">
    ...
    <div class="featured-items-wrapper">
      ...
      if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
          ...
          $image = '/Serandi 2/php/uploads/product/' . htmlspecialchars($row['image']);
          ...
          echo '
              <div class="item-box" data-price="' . $Price . '">
                  ...
                  <form action="/Serandi 2/detail-page.php" method="POST">
