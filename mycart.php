<?php
ob_start(); // Buffer output to prevent premature sending of headers
session_start();
...
if (isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity']) > $session_timeout) {
    session_unset();
    session_destroy();
    header("Location: /Serandi 2/login.php"); // ✅ Redirect before output
    exit();
}
...
// Now safe to continue with page content (HTML or PHP)
$is_logged_in = true;
