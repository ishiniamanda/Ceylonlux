    ...
    <div class="row">
        <div class="col-md-2 bg-light vh-100">
          <div class="col-12" id="sidebar">
            <a href="\Serandi 2\php\bashbord.php"><i class="fas fa-tachometer-alt mt-4"></i> Dashboard</a>
                ...
                <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                               ...
                               <a href="\Serandi 2\php\userdetails.php" class="text-primary">See All</a>
                            </div>
                            <div class="card-body">
                               <div class="card-body">
    ...
    while ($row = $reviewresults->fetch_assoc()) {
        echo '<div class="feedback-list">
                  <div class="d-flex align-items-center mb-3">
                      <img src="/Serandi 2/Images/image 1.jpeg" class="rounded-circle me-2" style="width: 50px; height: 50px;" alt="User Image">
                      <div>
